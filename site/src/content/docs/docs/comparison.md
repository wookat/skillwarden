---
title: Comparison
description: How SkillGate compares with Snyk Agent Scan, skillgate.sh, skill-tools, skill-check, and skillmds — source-verified.
---
...
> drift. SkillGate is under active development — rows not yet shipped are marked
> "planned". The canonical, maintained version of this document is
> [docs/COMPARISON.md](https://github.com/wookat/skillgate/blob/main/docs/COMPARISON.md).
