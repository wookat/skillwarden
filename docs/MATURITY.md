# SkillGate 成熟度清单（对齐 AgentGate docs/MATURITY.md 标准）
...
- [x] 供应链自卫：CI actions pin 到 SHA、依赖 `--frozen-lockfile`、SECURITY.md、dogfood（CI 用 skillgate 扫 examples）
- [x] lockfile 规范 v1 冻结：docs/spec/lockfile-v1.md（版本字段 + 迁移策略）

## B · 平台与文档
- [ ] 文档站（Astro/Starlight + Cloudflare Pages，先 pages.dev，后 skillgate.zalize.com）
